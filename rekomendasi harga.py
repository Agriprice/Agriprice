...
# sns.lineplot(data=df,x='Tanggal',y='IRMedPW')
...
scaler = MinMaxScaler()
scaler.fit(train[['IRMedPW']])

train['scaled'] = scaler.transform(train[['IRMedPW']])
test['scaled'] = scaler.transform(test[['IRMedPW']])
...
# plt.figure(figsize=(15,8))
# sns.lineplot(data=train, x='Tanggal', y='IRMedPW', label = 'train')
...
# plt.figure(figsize=(15,8))
# sns.lineplot(data=test, x='Tanggal', y='IRMedPW', label = 'test')
...
# plt.figure(figsize=(15,8))
# sns.lineplot(data=test[-60:], x='Tanggal', y='IRMedPW', label = 'test')
# sns.lineplot(data=test[-60:], x='Tanggal', y='predict', label = 'predict')
...
y_test = scaler.transform(test[['IRMedPW']])
n_future = 31*4
future = [[y_test[-1,0]]]
...
sns.lineplot(data=test[-365:], x='Tanggal', y='IRMedPW', label = 'Aktual')
